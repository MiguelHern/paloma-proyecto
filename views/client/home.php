    ...
    <header class="bg-white">
        <nav class="mx-auto flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            <div class="hidden lg:flex lg:gap-x-12 w-11/12 justify-center ">
                ...
                <a href="http://localhost/paloma/" class="text-sm/6 font-semibold text-gray-900">
                ...
                <a href="http://localhost/paloma/carrito" class="text-sm/6 font-semibold text-gray-900">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
