...
<script>
    ...
    function initializeProgress(step) {
        ...
        [step1, step2, step3].forEach((el) => {
            ...
            el.disabled = false; // Habilita todos los botones al inicio
        });
        ...
        // Si el estado es 3, deshabilitar todos los botones
        if (step === 3) {
            [step1, step2, step3].forEach((el) => {
                el.disabled = true;
    ...
    function updateProgress(step) {
        ...
        fetch('../controller/carrusel.php?action=updateStatus', {
            method: 'POST',
